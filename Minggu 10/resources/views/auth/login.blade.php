    ...
    <div class="login-wrap">
        ...
        <div class="input-group">
            ...
            <input placeholder="Email" id="email" type="Email"
                class="form-control @error('email') is-ivalid @enderror" name="email" value="{{ old('email') }}" 
        ...
        <div class="input-group">
            ...
            <input placeholder="Password" id="password" type="Password"
                class="form-control @error('password') is-ivalid @enderror" name="password" required
